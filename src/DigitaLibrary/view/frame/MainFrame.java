...
public class MainFrame extends JFrame {
	...
	public MainFrame(Biblioteca data, User user) {
		...
		/*  Tasto Cerca  */
		Action actFind = new ControllerInterface( this, data, listaOpera, cercaField, group, null, null);
		JButton btnCerca = new JButton("Cerca");
		btnCerca.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnCerca.setBounds(173, 50, 68, 31);
		btnCerca.setSize(65, 30);
		btnCerca.addActionListener(actFind);
		...
		/*  Tasto Visualizza  */
		Action actShowOpera = new ControllerInterface( this, data, listaOpera, list, user, null, null);
		...
		btnVisualizza.addActionListener(actShowOpera);
		if(role != 0) 
		...
		if(role == 0){
			...
			MouseController actGeneral = new MouseController( this.data, "MainFrame", list, autore, pagine, btnVisualizza, status);
			list.addMouseListener(actGeneral);
		...
		if(role == 1){
			...
			MouseController actAdvanced = new MouseController( this.data, "MainFrame", list, autore, pagine, btnVisualizza, status);
			list.addMouseListener(actAdvanced);
		}
		...
		if(role > 1){
			...
			MouseController actSuper = new MouseController( this.data, "MainFrame", list, autore, pagine, btnVisualizza,status);
			list.addMouseListener(actSuper);
		}
		...
		if(role == 2 || role == 4){
			...
			Action actOperationAT = new ControllerInterface( this, data, listaOpera, list, user, null, null);
			...
			btnAcquisisci.addActionListener(actOperationAT);
		...
		if(role == 2 || role == 4){
			...
			btnCronologiaOperazioni.addActionListener(actCrono);
			contentPane.add(btnCronologiaOperazioni);
		}
		
		/*	Admin  */
		if(role == 6){
			Action actAdmin = new ControllerInterface( this, data, listaOpera, list, user, null, null);
			...
			btnPubblica.addActionListener(actAdmin);
			...
			btnNuovaOpera.addActionListener(actAdmin);
			...
			btnElimina.addActionListener(actAdmin);
			...
			btnGestisciPag.addActionListener(actAdmin);
			...
			btnUtenti.addActionListener(actAdmin);
