...
public class RegistrazioneFrame extends JFrame {
	...
	public RegistrazioneFrame(Biblioteca data) {
		...
		/* -- Invio dati -- */
		Action act = new ControllerInterface(this, data, null, userField, passField, passField_repeat, emailField);
		
		JButton btnConferma = new JButton("Invia Dati");
		btnConferma.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnConferma.setBounds(95, 240, 105, 31);
		btnConferma.setSize(80, 33);
