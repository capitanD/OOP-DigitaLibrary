...
public class ReportFrame extends JFrame {
	...
	public ReportFrame(Biblioteca data, String opera, int pagine, int operation, JFrame revF) throws Exception {
		...
		Action actRepo = new ControllerInterface(this, data, null, reportField, opera, pagine, operation);
		JButton btnConfirm = new JButton("Conferma");
		btnConfirm.setSize(95, 30);
		btnConfirm.setLocation(92, 80);
		btnConfirm.addActionListener(actRepo);
