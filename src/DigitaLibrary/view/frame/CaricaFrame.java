...
public class CaricaFrame extends JFrame {
	...
	public CaricaFrame(Biblioteca data, Opera opera, User user) throws Exception {
		...
		Action actSelect = new ControllerInterface(this, data, null, pathField, lblImage, null, null);  		
		...
		btnScegliFile.addActionListener(actSelect);   
		...
		Action actUpdate = new ControllerInterface(this, data, null, pathField , npaginaField, user, opera);
		
		JButton btnUpload = new JButton("Carica");
		btnUpload.setBounds(570, 312, 85, 33);
		btnUpload.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnUpload.addActionListener(actUpdate);
