...
public class RevisioneImgFrame extends JFrame {
	...
	public RevisioneImgFrame(Biblioteca data, String opera, int page) throws Exception {
		...
		ControllerInterface actImg = new ControllerInterface(this, data, null, lblImage, opera, page, null);
		
		GestionePagina imgQuality = new GestionePagina(data, lblImage, opera, page, null);
		image =  imgQuality.scaleImage(480, 540, image);
		imgQuality.setImage(image);
		...
		btnZoomIn.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnZoomIn.setBounds(46, 605, 40, 23);
		contentPane.add(btnZoomIn);
		btnZoomIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GestionePagina plus = new GestionePagina(data, image, null, null, null);
				ImageIcon imageIconPlus = new ImageIcon(plus.zoomIn());
				lblImage.setIcon(imageIconPlus);
			}
		});
		
		JButton btnZoom_Out = new JButton(" - ");
		btnZoom_Out.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnZoom_Out.setBounds(74, 605, 40, 23);
		btnZoom_Out.addActionListener(actImg);
		contentPane.add(btnZoom_Out);
		btnZoom_Out.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GestionePagina minus = new GestionePagina(data, image, null, null, null);
				ImageIcon imageIconPlus = new ImageIcon(minus.zoomOut());
				lblImage.setIcon(imageIconPlus);
			}
		});
		...
		btnApprova.addActionListener(actImg);
		...
		btnRifiuta.addActionListener(actImg);
